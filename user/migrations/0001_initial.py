# Generated by Django 3.2.15 on 2022-12-26 22:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(blank=True, max_length=75, verbose_name='nickname')),
                ...
                ('card_number', models.CharField(blank=True, max_length=16, unique=True, verbose_name='card_number')),
                ('phone', models.IntegerField(unique=True, verbose_name='phone')),
                ('language', models.BooleanField()),
                ('sex', models.BooleanField()),
                ('birthday', models.DateField(verbose_name='birthday')),
                ('day_reg', models.DateTimeField(auto_now_add=True, verbose_name='date_joined')),
